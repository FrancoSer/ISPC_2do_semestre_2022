    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_carrito', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.carrito')),
                ('id_paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.paciente')),
        ...
        migrations.AddField(
            model_name='carrito',
            name='paciente',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.paciente'),
        ),
        migrations.AddField(
            model_name='carrito',
            name='servicio',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.servicio'),
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
